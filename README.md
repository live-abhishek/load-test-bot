...
- Navigate to `load-test-bot` folder
- Select `load-test-bot.bot` file
...
msbot clone services --name "load-test-bot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
